...
단계  |	주제  | 목표
-----------------------------------------------------
1단계	Vue 시작	Vue 프로젝트 구조 이해
2단계	템플릿 문법	화면에 데이터 출력
3단계	반응형 데이터	데이터 변화에 따라 화면 변경
4단계	이벤트	사용자 입력 처리
5단계	조건문/반복문	목록과 조건부 화면
6단계	컴포넌트	화면을 기능별로 분리
7단계	Props / Emit	부모-자식 컴포넌트 통신
8단계	Composition API	ref, reactive, computed, watch
9단계	TypeScript	Vue + TypeScript
